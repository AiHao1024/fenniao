define(['jquery', 'bootstrap', 'backend', 'form', 'ace/ace', 'tools'], function ($, undefined, Backend, Form, ace, undefined) {
    ...
    var Controller = {
        index: function () {
            ...
            var parent_title = $('.layui-layer-title', window.parent.document).html() + '&nbsp;' + Config.filepath;
            $('.layui-layer-title', window.parent.document).html(parent_title);
            editor.on("change", function () {
                $('.layui-layer-title', window.parent.document).html(parent_title + '<b style="color: #f00">&nbsp;*</b>');
            });
