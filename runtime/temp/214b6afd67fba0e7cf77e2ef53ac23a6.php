...
<script type="text/javascript">
    ...
    <!--        <input id="c-type" data-rule="required" data-source="news_type/index" class="form-control selectpage" name="row[type]" type="text" value="">-->
    <!--    </div>-->
    <!--</div>-->
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-detail" class="form-control " rows="5" name="row[detail]" cols="50"></textarea>
        </div>
    </div>
